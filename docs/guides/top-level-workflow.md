...
- a boundary that needs clarity  
- a relationship that needs a sentence  
- a plane that needs a stability clause  
...
## 4. Step 3 — Select the Right Brush
Choose the smallest tool that fits the gap:
...
Just pick the brush that feels kind.
...
Not ten.  
Not a whole tree.  
Just a happy little branch.

---

## 6. Step 5 — Step Back and Look
Pause.  
...
If yes — you’re done.  
If not — add one more tiny stroke.
...
- commit the change  
- push the update  
- let the architecture dry  

No urgency.  
No pressure.  
Just a gentle commit.

---

## 9. Step 8 — Return to Stillness
...
## 10. Step 9 — Choose the Next Region
When you’re ready — not before — choose the next region:
...
- maybe Documentation  
- maybe an Appendix  
- maybe nothing at all today  

The workflow loops gently.  
Never force the loop.

---

## 11. Summary
This top-level workflow keeps UMA gentle, stable, and joyful.  
It ensures:
